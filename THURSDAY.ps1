...
C:\Windows\System32\RunasSystem_x64.exe "C:\Windows\system32\RunFromToken64.exe trustedinstaller.exe 1 C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe"
